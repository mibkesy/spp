                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="row">
                                          <div class="form-group col-md-6">
                                              <label>Jumlah</label>
                                              <input class="form-control" type="number" min="0" name="jml" value="<?php echo set_value('jml'); ?>">
                                          ...
                                          <div class="form-group col-md-6">
                                             ...
                                             <select name="ket" class="form-control">
                                                ...
                                                <?php foreach($biayalain as $bin): ?>
                                                    <option value="<?php echo $bin['bila_ket']; ?>" <?php echo set_select('ket', $bin['bila_ket']); ?>><?php echo $bin['bila_ket']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
