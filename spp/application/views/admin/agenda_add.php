                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="text" name="judul" value="<?php echo set_value('judul'); ?>" autofocus>
                                            <small class="text-danger"><?php echo form_error('judul'); ?></small>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Warna Agenda</label>
                                            <input class="form-control" type="color" name="warna" value="<?php echo set_value('warna'); ?>">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="date" min="<?php echo date('Y-m-d'); ?>" name="start" value="<?php echo set_value('start'); ?>">
                                            <small class="text-danger"><?php echo form_error('start'); ?></small>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Tanggal Selesai (optional)</label>
                                            <input class="form-control" type="date" min="<?php echo date('Y-m-d'); ?>" name="end" value="<?php echo set_value('end'); ?>">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="time" name="times" value="<?php echo set_value('times'); ?>">
                                            <small class="text-danger"><?php echo form_error('times'); ?></small>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Jam Selesai (optional)</label>
                                            <input class="form-control" type="time" name="timee" value="<?php echo set_value('timee'); ?>">
