                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="kelas" class="form-control">
                                                ...
                                                <option <?php if($biaya['baka_kelas'] == $kls['id']) {echo 'selected="selected"'; } ?> value="<?php echo $kls['id']; ?>"><?php echo $kls['kelas']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="tahun" class="form-control">
                                                ...
                                                <option <?php if($biaya['baka_ta'] == $ta['ta_tahun']) {echo 'selected="selected"'; } ?> value="<?php echo $ta['ta_tahun']; ?>"><?php echo $ta['ta_tahun']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <small class="text-danger"><?php echo form_error('tahun'); ?></small>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label>Biaya Akademik</label>
                                            <input class="form-control" type="number" min="0" name="biaya" value="<?php echo $biaya['baka_biaya']; ?>">
