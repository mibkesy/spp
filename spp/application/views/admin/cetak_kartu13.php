      ...
      <?php foreach($bulan as $sis): ?>
        ...
        <td style="text-align: center; height: 18px;">
          <?php foreach($cek1 as $c1): ?>
            ...
            <?php $cek3 = $this->db->get_where('tb_transaksi',['transaksi_tgl' => date('Y-m-d'), 'transaksi_id' => $c1['trabu_transaksiid'], 'transaksi_siswaid' => $this->uri->segment(4), 'transaksi_ta' => $cek['ta_tahun']])->row_array(); ?>
            <?php if($cek3) { ?>
