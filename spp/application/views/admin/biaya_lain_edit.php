                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="row">
                                      <div class="form-group col-md-4">
                                          ...
                                          <input class="form-control" type="text" name="ket" value="<?php echo $bila['bila_ket']; ?>" autofocus>
                                      ...
                                      <div class="form-group col-md-4">
                                          ...
                                          <select name="kelas" class="form-control">
                                            ...
                                            <option <?php if($bila['bila_kelas'] == $kls['id']) {echo 'selected="selected"'; } ?> value="<?php echo $kls['id']; ?>"><?php echo $kls['kelas']; ?></option>
                                            <?php endforeach; ?>
                                          </select>
                                      ...
                                      <div class="form-group col-md-4">
                                          ...
                                          <input class="form-control" type="number" min="0" name="biaya" value="<?php echo $bila['bila_biaya']; ?>">
