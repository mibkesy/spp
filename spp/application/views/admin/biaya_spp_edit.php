                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="nis" class="form-control select2">
                                                ...
                                                <option <?php if($biaya['bspp_siswaid'] == $sis['siswa_nis']) {echo 'selected="selected"'; } ?> value="<?php echo $sis['siswa_nis']; ?>"><?php echo $sis['siswa_nama']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="tahun" class="form-control">
                                                ...
                                                <option <?php if($biaya['bspp_ta'] == $ta['ta_tahun']) {echo 'selected="selected"'; } ?> value="<?php echo $ta['ta_tahun']; ?>"><?php echo $ta['ta_tahun']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input class="form-control" type="number" min="0" name="biaya" value="<?php echo $biaya['bspp_biaya']; ?>">
